...
def get_dataframe(file_path):
    ...
    source_data =  pandas.read_csv('/content/drive/MyDrive/DFGN/hotpot_ss_dev.csv')
    sentence_pair_list = []
    for row,items in source_data.iterrows():
            pair_dict = dict()
            pair_dict['label'] = items['label']
            pair_dict['title'] = items['title']
            pair_dict['context'] = items['context']
            pair_dict['question'] = items['question']
            sentence_pair_list.append(pair_dict)
