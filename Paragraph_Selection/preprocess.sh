...
python paragraph_selection/train.py \
    --input_path=/content/drive/MyDrive/DFGN/train_select \
    --output_path=/content/drive/MyDrive/DFGN/train_select \
    --ckpt_path=/content/drive/MyDrive/DFGN/train_select \
    --split=${OUTPUT_DIR}
